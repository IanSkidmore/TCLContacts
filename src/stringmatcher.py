...
sm = StringMatcher("Skidmore")
print "Garbage", sm.Match("Garbage")
print "Skidmore", sm.Match("Skidmore")
print "Skydnorre", sm.Match("Skydnorre")
print "Skydmoore", sm.Match("Skydmoore")
print "Skimdore", sm.Match("Skimdore")
print "Skimdoer", sm.Match("Skimdoer")
print "Skiddmore", sm.Match("Skiddmore")
print "Skiddmoore", sm.Match("Skiddmoore")

nm = SynonymMatcher("Daniel", r"C:\Users\IAN\Documents\Python Scripts\synonyms.csv")
print "Daniel", nm.Match("Daniel")
print "Dan", nm.Match("Dan")
print "Danny", nm.Match("Danny")
print "Dani", nm.Match("Dani")
print "Danel", nm.Match("Danel")
